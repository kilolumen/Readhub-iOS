...
@property (nonatomic, strong) RHBlockchainLayout *layout;

@end

@implementation RHBlockchainCell
...
- (void)setLayout:(RHBlockchainLayout *)layout {
    ...
    self.titleLabel.text = layout.blockchain.title;
